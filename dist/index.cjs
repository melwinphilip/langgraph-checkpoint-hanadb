...
exports.HANADBCheckpointSaver = void 0;
const langgraph_checkpoint_1 = require("@langchain/langgraph-checkpoint");
const hana_client_1 = require("@sap/hana-client");

/**
 * A LangGraph checkpoint saver backed by an HANA database.
 */
class HANADBCheckpointSaver extends langgraph_checkpoint_1.BaseCheckpointSaver {
...
exports.HANADBCheckpointSaver = HANADBCheckpointSaver;